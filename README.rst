...
``pfdo_med2img.py`` is a ChRIS-based application that...
...
.. code:: bash
    ...
    pip install pfdo_med2img

and run with

.. code:: bash

    pfdo_med2img.py --man /tmp /tmp

to get inline help. The app should also understand being called with only two positional arguments

.. code:: bash

    pfdo_med2img.py /some/input/directory /destination/directory
